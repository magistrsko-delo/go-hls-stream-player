...
// source: proto/timeshift_service/timeshift_service.proto
...
func (*TimeShiftRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e59ea7dc9ba53d, []int{0}
}
...
func (*TimeShitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e59ea7dc9ba53d, []int{1}
}
...
func (*ChunkResolutionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e59ea7dc9ba53d, []int{2}
}
...
func (*ChunkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7e59ea7dc9ba53d, []int{3}
}
...
func init() {
	proto.RegisterFile("proto/timeshift_service/timeshift_service.proto", fileDescriptor_f7e59ea7dc9ba53d)
}

var fileDescriptor_f7e59ea7dc9ba53d = []byte{
	...
	,
}
...
var _Timeshift_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/timeshift_service/timeshift_service.proto",
}
